...
-- 2017-01-01,NYousif,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_NYousif')
	 Begin 
	  Alter Database [Assignment06DB_NYousif] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_NYousif;
	 End
	Create Database Assignment06DB_NYousif;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_NYousif;
